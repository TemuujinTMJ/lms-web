    ...
    <div>
      <div className={style.header}>
        ...
        <div className={style.header1}>
          <Input placeholder="Хайх" style={{ width: '200px', marginRight: '10px' }} />
          {type === 3 ? null : (
            <Button type="primary" onClick={showModal}>
              {type === 1 ? 'хэрэглэгч нэмэх' : 'Лаборатори хариуцсан багш нэмэх'}
            </Button>
          )}
        </div>
      </div>
      ...
      <Modal
        title={type === 1 ? 'Лабораторийн анги нэмэх' : 'Лаборатори хариуцсан багш нэмэх'}
        open={isModalOpen}
        onOk={handleOk}
        ...
        cancelText="Буцах"
      >
        <Form labelCol={{ span: 24 }} wrapperCol={{ span: 24 }} layout="vertical" style={{ maxWidth: 800 }}>
